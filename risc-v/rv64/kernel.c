...
#define UART0_THR (UART0_BASE + 0x00ull)
#define UART0_LSR (UART0_BASE + 0x05ull)
#define UART_LSR_THRE 0x20u

#define CLINT_MTIME_LOW 0x0200BFF8ull
#define CLINT_MTIME_HIGH 0x0200BFFCull
...
void kernel_main(void) {
    uart_puts("RalphOS: hello from RV64!\n");
    delay_seconds(10);
